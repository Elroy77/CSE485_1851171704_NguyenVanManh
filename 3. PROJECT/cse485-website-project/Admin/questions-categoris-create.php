...
<body>
    ...
    <section class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <form role="form" method="post" action="question-category-create-process.php">
                    ...
                    <a href="questions-categoris-index.php" class="btn btn-secondary" name="reset">Quay lại</a>
                </form>
            </div>
        </div>
    </section>
